<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:0f172a,100:38bdf8&height=200&section=header&text=Sadia%20Rahman&fontSize=38&fontColor=ffffff&animation=fadeIn&fontAlignY=35" />
</p>
...
I enjoy working with JavaScript and react based technologies and continuously learning new
tools to improve performance, scalability, and user experience.
## 🔭 Current Activities
...
• Security features (copy-paste prevention & tab switching detection)  
• Stripe payment system with transaction tracking  
• Admin Dashboard with real-time statistics, revenue charts, and analytics  
• Recent activity tracking and user distribution insights  

**Tech Stack:** `Next.js` `MongoDB` `NextAuth.js`
...
<p align="left">
  ...
  <a href="https://online-secure-exam-one.vercel.app/" target="_blank">
